...
public class FlashForm extends javax.swing.JFrame  implements  Runnable
{
    ...
    public void run(){
        try
        {
            Player play=Manager.createRealizedPlayer(new File("E:\\Netbeans Program\\HosterlReportFinder\\src\\welcome.wav").toURI().toURL());
            play.start();
            for(int i=0;i<=100;i++)
            {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/welcome1.jpg"))); // NOI18N

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/logo.png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        jLabel3.setText("            Hostel Report Finder");
