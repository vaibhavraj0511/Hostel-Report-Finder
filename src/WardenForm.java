...
public class WardenForm extends javax.swing.JFrame {
    ...
    public WardenForm() {
        ...
        /*View Student*/
        Criteria crit = session.createCriteria(HRF.dto.Student.class);
        List<HRF.dto.Student> sData = crit.list();
        DefaultTableModel dtm = (DefaultTableModel)jTable1.getModel();
        for(HRF.dto.Student st:sData){
    ...
    private void initComponents() {
        ...
        jLabel64.setText(" Request Record");
        ...
        jLabel66.setText("       Delete Record");
        ...
        jLabel65.setText("       Request Record View");
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addComponent(jScrollPane13, javax.swing.GroupLayout.DEFAULT_SIZE, 821, Short.MAX_VALUE)
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGap(259, 259, 259)
                .addComponent(jLabel65, javax.swing.GroupLayout.PREFERRED_SIZE, 304, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            ...
            .addGroup(jPanel17Layout.createSequentialGroup()
                ...
                .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(jLabel76, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jPasswordField6, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(68, 319, Short.MAX_VALUE))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Session session = sf.openSession();
        Transaction  tx=session.beginTransaction();
        HRF.dto.Student stud = new HRF.dto.Student(sId,sName,sPass,sEmail,sDOB,sFatherName,sMotherName,sPMobileNo,sMobileNo,sAddress);
        session.save(stud);
        tx.commit();
        session.close();
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        if(data.isEmpty()){
            ...
            if(newPass.equals(cNewPass)){
                Warden war = (Warden)session.get(Warden.class,id);
                war.setPassword(newPass);
                session.update(war);
                tx.commit();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        Record rec = (Record)session.get(Record.class, item);
        session.delete(rec);
        tx.commit();
        session.close();
